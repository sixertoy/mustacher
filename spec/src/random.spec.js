    ...
    describe('random', function () {
        ...
        describe('render', function () {
            ...
            it('throw wrong arguments', function () {
                expect(function () {
                    helper.render({prop: 'prop'}, defaults);
                }).to.throw('missing arguments');
            });
            it('throw wrong arguments', function () {
                expect(function () {
                    helper.render(123, {prop: 'prop'}, defaults);
                }).to.throw('missing arguments');
            });
            it('throw wrong arguments', function () {
                expect(function () {
                    helper.render(123, 123, {prop: 'prop'}, defaults);
                }).to.throw('missing arguments');
            });
